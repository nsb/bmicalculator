...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "587272b9d39626ad67b90942749f66f7.png";
...
/***/ function(module, exports) {
	...
	var _nsb$bmicalculator$Main$decodeGifUrl = A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['data', 'image_url']),
		_elm_lang$core$Json_Decode$string);
	var _nsb$bmicalculator$Main$subscriptions = function (model) {
		return _elm_lang$core$Platform_Sub$none;
	};
	var _nsb$bmicalculator$Main$roundTo = function (places) {
	...
	var _nsb$bmicalculator$Main$bmi = function (model) {
		var h = _elm_lang$core$Basics$toFloat(model.height) / 100;
		return A2(
			_nsb$bmicalculator$Main$roundTo,
			2,
			_elm_lang$core$Basics$toFloat(model.weight) / (h * h));
	};
	var _nsb$bmicalculator$Main$Model = F3(
		function (a, b, c) {
			return {weight: a, height: b, gifUrl: c};
		});
	var _nsb$bmicalculator$Main$FetchFail = function (a) {
		return {ctor: 'FetchFail', _0: a};
	};
	var _nsb$bmicalculator$Main$FetchSucceed = function (a) {
		return {ctor: 'FetchSucceed', _0: a};
	};
	var _nsb$bmicalculator$Main$getRandomGif = function (topic) {
		var url = A2(_elm_lang$core$Basics_ops['++'], 'http://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=', topic);
		return A3(
			_elm_lang$core$Task$perform,
			_nsb$bmicalculator$Main$FetchFail,
			_nsb$bmicalculator$Main$FetchSucceed,
			A2(_evancz$elm_http$Http$get, _nsb$bmicalculator$Main$decodeGifUrl, url));
	};
	var _nsb$bmicalculator$Main$init = function (topic) {
		return {
			ctor: '_Tuple2',
			_0: A3(_nsb$bmicalculator$Main$Model, 0, 0, topic),
			_1: _nsb$bmicalculator$Main$getRandomGif(topic)
		};
	};
	var _nsb$bmicalculator$Main$update = F2(
				...
				case 'WeightChanged':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{weight: _p1._0}),
						_1: _nsb$bmicalculator$Main$getRandomGif('overweight')
					};
				case 'HeightChanged':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{height: _p1._0}),
						_1: _nsb$bmicalculator$Main$getRandomGif('underweight')
					};
				case 'FetchSucceed':
					return {
						ctor: '_Tuple2',
	...
	var _nsb$bmicalculator$Main$HeightChanged = function (a) {
		return {ctor: 'HeightChanged', _0: a};
	};
	var _nsb$bmicalculator$Main$WeightChanged = function (a) {
		return {ctor: 'WeightChanged', _0: a};
	};
	var _nsb$bmicalculator$Main$view = function (model) {
		var bmiVal = _nsb$bmicalculator$Main$bmi(model);
		...
		var onWeightChanged = onChanged(_nsb$bmicalculator$Main$WeightChanged);
		var onHeightChanged = onChanged(_nsb$bmicalculator$Main$HeightChanged);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('mx-auto')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									(_elm_lang$core$Basics$isInfinite(bmiVal) || _elm_lang$core$Basics$isNaN(bmiVal)) ? '--' : _elm_lang$core$Basics$toString(bmiVal))
								]))
						])),
					A2(
	...
	var _nsb$bmicalculator$Main$main = {
		main: _elm_lang$html$Html_App$program(
			{
				init: _nsb$bmicalculator$Main$init('overweight'),
				view: _nsb$bmicalculator$Main$view,
				update: _nsb$bmicalculator$Main$update,
				subscriptions: _nsb$bmicalculator$Main$subscriptions
			})
	};
	var _nsb$bmicalculator$Main$NoOp = {ctor: 'NoOp'};
	var _nsb$bmicalculator$Main$Obese = {ctor: 'Obese'};
	var _nsb$bmicalculator$Main$OverWeight = {ctor: 'OverWeight'};
	var _nsb$bmicalculator$Main$NormalWeight = {ctor: 'NormalWeight'};
	var _nsb$bmicalculator$Main$UnderWeight = {ctor: 'UnderWeight'};

	var Elm = {};
	Elm['Main'] = Elm['Main'] || {};
	_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _nsb$bmicalculator$Main$main === 'undefined' ? null : _nsb$bmicalculator$Main$main);
